...
import { ChainId, MASTERCHEF_ADDRESS, MASTERCHEF_V2_ADDRESS, MINICHEF_ADDRESS, Token } from '@conedex/core-sdkv2'
...
const APPROVAL_ADDRESSES = {
  ...
  [Chef.MINICHEF]: {
    ...
    [ChainId.MATIC_TESTNET]: MASTERCHEF_ADDRESS[ChainId.MATIC_TESTNET],
